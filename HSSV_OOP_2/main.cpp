...
Hãy tìm ra sinh viên có điểm thi chuyên ngành cao nhất lớp, nếu có nhiều sinh viên có điểm thi chuyên ngành bằng nhau thì xuất ra tất cả các sinh viên đó theo thứ tự 
tăng dần của tên.
*/
